<div>
    ...
    <form wire:target="store" wire:loading.class="skeleton" wire:submit.prevent='store' enctype="multipart/form-data">
        ...
        <div class="grid grid-rows-3 md:grid-cols-3 items-stretch gap-4 mt-2  divide-y-2 md:divide-x-2 divide-base-200 border  border-base-200 rounded-box">
            <div class='mx-4'>
            ...
            <div class='mx-4'>
                <fieldset class=" max-w-sm  fieldset rounded-box ">
