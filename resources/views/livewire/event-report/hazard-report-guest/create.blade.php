                ...
                <div wire:target="store" wire:loading.class="skeleton" class="modal-box">
                    ...
                    <form wire:submit.prevent='store'>
                        ...
                        <div class="w-full max-w-xs sm:max-w-sm xl:max-w-xl form-control">
                            ...
                            <div class="dropdown dropdown-end">
                                <x-input-search-with-error placeholder="search name"
                                    wire:model.live='responsibility_name' :error="$errors->get('responsibility_name')"
                        ...
                        <div class="w-full max-w-xs sm:max-w-sm xl:max-w-xl form-control">
                            ...
                            <x-input-date id="completion_date" wire:model.live='completion_date' readonly
